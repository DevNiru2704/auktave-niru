    ...
    <div className="pt-32 pb-24 px-5 lg:px-10 vines-bg" data-testid="sponsorship-page">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-bone/70 text-lg max-w-3xl leading-relaxed mb-12">
          AUKTAVE 2K26 is the first edition TechFest at Amity University Kolkata - which means founding sponsor status is on the table for exactly one cohort. Plug your brand into 500+ engineering students, 7 curated events, and a full IEEE SB AUK certified session.
        </p>
